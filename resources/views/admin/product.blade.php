                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button id="previewButton" type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#addModal" class="btn btn-success"> Add new product item</button>
                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ url($product->image) }}" alt="image" height="300px"
                                                        width="300px">
                                                </td>
                                                <td>
                                                    {{ $product->title }}
                                                ...
                                                <td>
                                                    {{ str($product->description)->take(20) }}...
                                                </td>
                                                <td>
                                                    {{ $product->url }}
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="modal fade .modal-xl" id="editModal{{ $product->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered "
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div id="modalBody" class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="">Description</label>
                                                                            <textarea name="description" class="form-control" id="" placeholder="Description">{{$product->description}}</textarea>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="">Url</label>
