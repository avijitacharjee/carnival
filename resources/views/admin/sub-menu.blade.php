                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                {{-- <h3 class="card-title">submenu items</h3> --}}
                                <button id="previewButton" type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#addModal" class="btn btn-success"> Add new submenu item</button>
                                    ...
                                    <tbody>
                                        @foreach ($subMenus as $subMenu)
                                            <tr>
                                                ...
                                                <td>{{$subMenu->menu->text}}</td>
                                                <td>
                                                    <button id="previewButton" type="button" class="btn btn-primary"
                                                        data-toggle="modal" data-target="#editModal{{ $subMenu->id }}"
                                                        class="btn btn-success"><i class="fa fa-edit"></i></button>
                                                    <div class="modal fade .modal-xl" id="editModal{{ $subMenu->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered "
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div id="modalBody" class="modal-body">
                                                                        <div class="form-group">
                                                                            <label for="">Text</label>
                                                                            <input type="text" name="text" class="form-control" value="{{$subMenu->text}}"
                                                                                id="" required placeholder="text">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="">Url</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="menu_id" id="" class="form-control">
                                                                                @foreach ($menus as $menu)
                                                                                    <option @selected($menu->id==$subMenu->menu->id) value="{{$menu->id}}">{{$menu->text}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
